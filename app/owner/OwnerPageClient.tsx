...
export default function OwnerPageClient({ companyId, initialAccountPlan = "free" }: OwnerPageClientProps) {
  ...
  // NOTE: Ownership is verified server-side in the page.tsx wrapper
  // This component is only rendered if the user is confirmed to be an owner
  // No client-side ownership checks needed here - security is enforced server-side
  
  // Load plan permissions and existing data
  useEffect(() => {
    const loadPermissions = async () => {
      try {
        ...
        // Get plan permissions (ownership already verified server-side)
